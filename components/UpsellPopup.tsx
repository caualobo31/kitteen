...
export default function UpsellPopup() {
  ...
  return (
    ...
    >
      ...
      <div className="fixed inset-0 flex items-center justify-center px-5 py-8 overflow-y-auto" onClick={() => setOpen(false)}>
        <div
          ref={cardRef}
          tabIndex={-1}
          role="dialog"
          aria-modal="true"
          className={`bg-surface-1 border border-border rounded-2xl p-7 md:p-8 w-full max-w-[440px] relative shadow-xl outline-none transition-[transform,opacity] duration-200 ${
